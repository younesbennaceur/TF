      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Suivez l'avancement de nos projets sur nos réseaux sociaux .
          </p>
        </div>
        ...
        <div className="flex justify-center mt-12">
            <Link to="/projets">
            <button className="bg-[#0565C4] hover:bg-[#0554a3] text-white px-8 py-3 rounded-md font-semibold transition-colors">
